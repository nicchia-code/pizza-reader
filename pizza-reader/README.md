...
Client-side Flutter app for fast reading ebooks. Pizza Reader imports standard
ebook/text formats in the browser, then reads one word at a time with a central
pivot letter and adjustable WPM.
...
- Private Supabase Storage upload/download/delete plus library/progress tables.
